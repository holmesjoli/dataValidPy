...
class BoolColsTestClass(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.tat1 = test_all_true_class(self.df.col1)
        self.tat2 = test_all_true_class(self.df.col2)
        self.tat3 = test_all_true_class(self.df.col3)

        self.taf1 = test_all_false_class(self.df.col1)
        self.taf2 = test_all_false_class(self.df.col2)
        self.taf3 = test_all_false_class(self.df.col3)

        self.tant1 = test_any_true_class(self.df.col1)
        self.tant2 = test_any_true_class(self.df.col2)
        self.tant3 = test_any_true_class(self.df.col3)

        self.tanf1 = test_any_false_class(self.df.col1)
        self.tanf2 = test_any_false_class(self.df.col2)
        self.tanf3 = test_any_false_class(self.df.col3)
